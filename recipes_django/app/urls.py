...
from recipes_django.app.views import index
from recipes_django.app.views.index import index
from recipes_django.app.views.recipes import create_recipe, edit_recipe, delete_recipe, details_recipe
